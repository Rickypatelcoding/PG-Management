export default function ActionButton({ children, variant = 'primary', size = 'md', className = '', ...props }) {
  const styles = { primary: 'bg-[#e27d00] text-[#1a1a1a] hover:bg-[#bb5602] active:translate-y-px', secondary: 'bg-[#f5f5f5] text-[#292929] hover:bg-[#e6e6e6]', outline: 'border border-[#e6e6e6] bg-white text-[#292929] hover:bg-[#fafafa] hover:border-[#a5a5a5]', ghost: 'text-[#575757] hover:bg-[#f5f5f5]', danger: 'bg-[#dc2626] text-white hover:bg-[#b91c1c]' }
